function [errs, pt_3d, pts_2d_bp] = calculate_bpe_final(pts_2d,trs,ex,ey,xo,yo,focal,N)
...
pt_2d = {pts_2d{1};pts_2d{2}};
[pt_3d, d, d_array] = sm_recon_general_2(pt_2d,trs,ex,ey,xo,yo,focal);

pt2d=sm_backproj_general(pt_3d,trs{2},ex(2),ey(2),xo(2),yo(2),focal(2));
