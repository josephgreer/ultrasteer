function [pts_3d bpe_all pts_2d_bp] = match_seeds_hidden(pts_2d_all, cam_params, trs, total_seeds)
...
% calculate BPE
[bpe_all, pts_3d, pts_2d_bp_unordered] = calculate_bpe(pts_2d_matched,matched,trs,ex,ey,xo,yo,focal);
