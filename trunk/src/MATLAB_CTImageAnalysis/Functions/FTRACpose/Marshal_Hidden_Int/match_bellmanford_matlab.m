...
% MATCH_BELLMANFORD_MATLAB - runs the Bellman-Ford algorithm
%   This function performs the Bellman-Ford algorithm as part of the cycle
%   canceling algorithm.  This particular Matlab version is optimized for
%   speed in Matlab.  This returns whether or not a negative cycle was
%   found as mark, and the actual negative cycle itself.  
