...
if(counter==0)
    display 'Failed badly! Cannot find a good INITIAL GUESS for Pose with less than 2.5mm error (at each of the feature Points). Try increasing the max_avg_err to greater than 2.5mm error.';
    Pose = -1;
    Error = -1;
    return;
