function sm_seg4(dir,fim,x,y)
%sm_seg

%1. get the whole image;
%I0 = imread('images1\IM_00005.jpeg');
I0=imread(strcat(dir,fim,'.jpeg'));
%I0=imread('test.jpg');
%I0=rgb2gray(I0);
%figure;
%imshow(I0);
...
%saveas(h1,strcat(dir,fim,'_lines','.jpg'));
...
%saveas(h2,strcat(dir,fim,'_ellipescenters','.jpg'));
...
%saveas(h3,strcat(dir,fim,'_ellipesall','.jpg'));
...
ind2=flipud(ind1);
gefin=ger(ind2(1:2),:);
%saveas(h4,strcat(dir,fim,'_ellipesrp','.jpg'));
...
%saveas(h5,strcat(dir,fim,'_ellipes2sets','.jpg'));
...
%saveas(h6,strcat(dir,fim,'_centralellipes','.jpg'));
...
%saveas(h7,strcat(dir,fim,'_finalellipes','.jpg'));
Ls_fid3;
efin;