%$Id: Compute_Reconstruction_Errors.m,v 1.1 2006/11/21 18:37:26 jain Exp $
...
%variables. Also, CT to FTRAC registration is computed by optimization. The files 
%that you need in 'Ground_Truth_Dir_Name' are
%'Seeds_wrt_CT.txt', 'Fiducial_Points_wrt_CT.txt',
%'xform_FTRAC_to_Template.txt', 'True_Seeds_wrt_FTRAC.txt'.
function [Err, Err_Vecs] = Compute_Reconstruction_Errors(Groud_Truth_Dir_Name, Carm_Seeds_Dir_Name, Filename_Carm_Computed_Seeds)
...
True_Seeds_wrt_FTRAC = Compute_Seed_Locations_wrt_FTRAC(Groud_Truth_Dir_Name);
...
%$Log: Compute_Reconstruction_Errors.m,v $
