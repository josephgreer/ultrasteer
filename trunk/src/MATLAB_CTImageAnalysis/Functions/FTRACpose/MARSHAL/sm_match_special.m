function mm=sm_match_special(nnn,c_all,pt,tr,ex,ey,xo,yo,f)
...
if n_t>1
    for j=1:n_t
        ...
        if n_c<=N
            ...
            if k<7
                ...
                mm(cc+1:cc+k,:)=sm_match_special(nn,c_all,pt,tr,ex,ey,xo,yo,f);
            end
            cc=cc+k;
        end
    end
    ...
    while k-cc>=7
        cc=cc+1;
        [mm(cc,:),mmm]=sm_match_assist(mmm,pt,tr,ex,ey,xo,yo,f);
    end
