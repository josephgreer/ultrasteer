function [res_ra,res_re,res_bpe]=sm_main_fid4(f_dir,i_comb)
...
yo=cams{4}(4);
f=cams{4}(5);
p4=sm_backproj(pts_3d,trs{4},ex,ey,xo,yo,f);
[bpe4_mean,bpe4_std,bpe4_min,bpe4_max,bpe4]=sm_err_backproj_general(p4,pts_2d{4},ex,ey);
ex=cams{5}(1);
ey=cams{5}(2);
xo=cams{5}(3);
yo=cams{5}(4);
f=cams{5}(5);
p5=sm_backproj(pts_3d,trs{5},ex,ey,xo,yo,f);
[bpe5_mean,bpe5_std,bpe5_min,bpe5_max,bpe5]=sm_err_backproj_general(p5,pts_2d{5},ex,ey);
bpe=[bpe1;bpe2;bpe3;bpe4;bpe5];
bpe_mean=mean(bpe);
bpe_std=std(bpe);
bpe_min=min(bpe);
bpe_max=max(bpe);
