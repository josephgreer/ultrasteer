function [pts_3d,r,res_ra,res_ra_m,res_ra_u,res_bpe,res_bpe_m,res_bpe_u,res_re,res_re_m,res_re_u,res_ren,res_ren_m,res_ren_u]=sm_main_seeds_bigsim_focal(f_dir,i_comb,pts_2d_all,trs_all,pts_3d_truth,fe)
%SM_MAIN2 processes one 3-image combo of one data set.

%[pts_2d_all,trs_all,pts_3d_truth]=sm_readdata_seeds_bigsim(f_dir);
ns_im=[1,2,3;...
        1,2,4;...
        1,2,5;...
        1,2,6;...
...
for i=1:3
    ex(i,1)=0.25;
    ey(i,1)=0.25;
    xo(i,1)=600+e/sqrt(27)/ex(i,1);
    yo(i,1)=600+e/sqrt(27)/ey(i,1);
    f(i,1)=1000+e/sqrt(27)*5;
end
