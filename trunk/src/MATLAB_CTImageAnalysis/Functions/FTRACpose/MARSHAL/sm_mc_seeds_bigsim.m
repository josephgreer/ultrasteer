function sm_mc_seeds_bigsim(ndir,pts_2d_all,trs_all,pts_3d_truth)
...
for k=1:5:N
    k
    t0=clock;
    [pts_3d,r,res_ra,res_ra_m,res_ra_u,res_bpe,res_bpe_m,res_bpe_u,res_re,res_re_m,res_re_u,res_ren,res_ren_m,res_ren_u]=sm_main_seeds_bigsim(ndir,k,pts_2d_all,trs_all,pts_3d_truth);
    t=etime(clock,t0)
    res=[k,0,0,r;...
        res_ra;...
        res_ra_m;...
