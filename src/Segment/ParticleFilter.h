...
namespace Nf
{
  ...
  public:
    ...
    f64 offFrameB0;                           //  p(off frame | distance projection) 1/(1+exp(-B0-B1*x))
    f64 offFrameB1;                           //  p(off frame | distance projection) 1/(1+exp(-B0-B1*x))
    ...
    std::string onNeedleDopplerLUTPath;       //  Path for on needle doppler distribution look up table generated by kernel density estimation
    std::string offNeedleDopplerLUTPath;      //
