...
#define PATH_CAT(x) (std::string("Z:/Dropbox (Stanford CHARM Lab)/Joey Greer Research Folder/Data/NeedleScan/1_7_16/")+std::string(x)).c_str()
#define BASE_PATH_CAT(x) (std::string("C:/Joey/ultrasteer/data")+std::string(x)).c_str()
