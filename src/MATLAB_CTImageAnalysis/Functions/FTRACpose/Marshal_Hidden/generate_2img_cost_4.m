function tab_c = generate_2img_cost_4(pts_2d,trs,ex,ey,xo,yo,f)
...
n_seeds1 = size(pts_2d{1}, 1);
n_seeds2 = size(pts_2d{2}, 1);
n_seeds3 = size(pts_2d{3}, 1);
n_seeds4 = size(pts_2d{4}, 1);
