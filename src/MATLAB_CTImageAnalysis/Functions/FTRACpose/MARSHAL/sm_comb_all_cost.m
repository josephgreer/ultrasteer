function ee=sm_comb_all_cost(bb,pts_2d,trs,ex,ey,xo,yo,f)
...
%returns EE as the list of accuracy values corresponding to bb.
...
for i=1:n_comb
    ...
    [tmp,ee(i)]=sm_recon_core(pt_2d,trs,ex,ey,xo,yo,f);
end
