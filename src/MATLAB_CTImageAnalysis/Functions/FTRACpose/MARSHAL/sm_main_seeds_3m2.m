...
c=cell(3,1);
c{1}=sm_cost_matching_bp5_new2(pts_2d,trs,ex,ey,xo,yo,f);
c{2}=sm_cost_matching_bp5_new2({pts_2d{2};pts_2d{3};pts_2d{1};pts_2d{4};pts_2d{5}},{trs{2};trs{3};trs{1};trs{4};trs{5}},[ex(2);ex(3);ex(1);ex(4);ex(5)],[ey(2);ey(3);ey(1);ey(4);ey(5)],[xo(2);xo(3);xo(1);xo(4);xo(5)],[yo(2);yo(3);yo(1);yo(4);yo(5)],[f(2);f(3);f(1);f(4);f(5)]);
c{3}=sm_cost_matching_bp5_new2({pts_2d{3};pts_2d{1};pts_2d{2};pts_2d{4};pts_2d{5}},{trs{3};trs{1};trs{2};trs{4};trs{5}},[ex(3);ex(1);ex(2);ex(4);ex(5)],[ey(3);ey(1);ey(2);ey(4);ey(5)],[xo(3);xo(1);xo(2);xo(4);xo(5)],[yo(3);yo(1);yo(2);yo(4);yo(5)],[f(3);f(1);f(2);f(4);f(5)]);
