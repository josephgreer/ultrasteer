function [r,ec_gd,e3_gd,e2_gd,ec_bd,e3_bd,e2_bd]=sm_main6(f_dir,i_comb)
...
c=cell(3,1);
c{1}=sm_cost_matching_bp5_new(pts_2d(1:3),trs,ex,ey,xo,yo,f);
c{2}=sm_cost_matching_bp5_new({pts_2d{2};pts_2d{3};pts_2d{1}},{trs{2};trs{3};trs{1}},ex,ey,xo,yo,f);
c{3}=sm_cost_matching_bp5_new({pts_2d{3};pts_2d{1};pts_2d{2}},{trs{3};trs{1};trs{2}},ex,ey,xo,yo,f);
