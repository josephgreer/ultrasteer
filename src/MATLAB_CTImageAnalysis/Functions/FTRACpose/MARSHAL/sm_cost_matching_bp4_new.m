function tab_c=sm_cost_matching_bp4_new(pts_2d,trs,ex,ey,xo,yo,f)
...
[pt_3d,d]=sm_recon_general(pt_2d,trs(1:3),ex,ey,xo,yo,f);
%backproject to 4;
pt2d=sm_backproj_general(pt_3d,trs{4},ex,ey,xo,yo,f);
