...
init_triplets=[matched(:,1:3);unmatched(:,1:3)];
[p3,tmp]=sm_recon({pts_2d{1}(init_triplets(1:n_seeds,1),:);pts_2d{2}(init_triplets(1:n_seeds,2),:);pts_2d{3}(init_triplets(1:n_seeds,3),:)},trs,[matched(:,4);unmatched(:,4)],ex,ey,xo,yo,f);
