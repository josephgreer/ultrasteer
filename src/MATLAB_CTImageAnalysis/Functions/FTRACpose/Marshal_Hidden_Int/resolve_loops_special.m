...
% RESOLVE_LOOPS_SPECIAL - special function to resolve loops
%   This function is only used for resolvig the loops created by the
%   network flow method of breaking down the large loops generated by the
%   network flow.  
