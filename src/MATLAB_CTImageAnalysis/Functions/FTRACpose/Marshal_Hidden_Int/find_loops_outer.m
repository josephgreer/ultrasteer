function [matched, loops, mis_matched_seeds] = find_loops_outer(matching, pts_2d, trs, ex, ey, xo, yo, focal)
% FIND_LOOPS_OUTER - find loops when resolving outer hidden seeds
%   This function is a modified version of find_loops for finding loops
%   when trying to resolve the outer hidden seed mismatch.

[matched, mis_matched, mis_matched_seeds, incorrect_hidden, bpe_thresh] = remove_subgroups(matching, 2, pts_2d, trs, ex, ey, xo, yo, focal);
