...
namespace Nf
{
    ...
    , ParameterCollection("RP Streaming")
  {
    ...
    ADD_FLOAT_PARAMETER(m_mpp, "Microns Per Pixel", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, 87, 20, 500, 1.0);
    ADD_FLOAT_PARAMETER(m_sos, "Speed of Sound", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, 1540, 1300, 1800, 1.0);
    ADD_VEC2D_PARAMETER(m_origin, "Frame Origin", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, Vec2d(330, 78), Vec2d(-500,-500), Vec2d(10000, 10000), Vec2d(1,1));
