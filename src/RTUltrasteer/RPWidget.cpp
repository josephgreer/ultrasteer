...
namespace Nf
{
    ...
    , ParameterCollection("RP Streaming")
  {
    ...
    //ADD_FLOAT_PARAMETER(m_mpp, "Microns Per Pixel", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, 405, 20, 500, 1.0); //18 mm depth
    ADD_FLOAT_PARAMETER(m_mpp, "Microns Per Pixel", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, 276, 20, 500, 1.0); // 12 mm depth
    ADD_FLOAT_PARAMETER(m_sos, "Speed of Sound", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, 1540, 1300, 1800, 1.0);
    //ADD_VEC2D_PARAMETER(m_origin, "Frame Origin", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, Vec2d(330, -56), Vec2d(-500,-500), Vec2d(10000, 10000), Vec2d(1,1)); //18 mm depth
    ADD_VEC2D_PARAMETER(m_origin, "Frame Origin", CALLBACK_POINTER(onFrameInfoChanged, RPPushReceiver), this, Vec2d(330, -117), Vec2d(-500,-500), Vec2d(10000, 10000), Vec2d(1,1)); //12 mm depth
    ADD_BOOL_PARAMETER(m_rcvBmode, "Receive Bmode", CALLBACK_POINTER(onDataToAcquireChanged, RPPushReceiver), this, true);
