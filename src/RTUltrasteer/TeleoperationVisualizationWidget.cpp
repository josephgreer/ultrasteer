...
namespace Nf
{
  ...
  void TeleoperationVisualizationWidget::initViewport(void)
  {
    if( !m_viewportInit ){ // if not already initialized
      // robot model
      m_robotSTLReader->SetFileName("F:/ultrasteer/models/NeedleSteeringRobot.STL");
      ...
      // estimate tip model
      m_estimateSTLReader->SetFileName("F:/ultrasteer/models/8mmBentTip.STL");
      ...
      m_measurementSTLReader->SetFileName("F:/ultrasteer/models/4mmBentTip.STL");
