...
namespace Nf
{
  ...
  void TeleoperationVisualizationWidget::initViewport(void)
  {
    if( !m_viewportInit ){ // if not already initialized
      // robot model
      m_robotSTLReader->SetFileName("C:/Joey/ultrasteer/models/NeedleSteeringRobot.STL");
      ...
      // estimate tip model
      m_estimateSTLReader->SetFileName("C:/Joey/ultrasteer/models/8mmBentTip.STL");
      ...
      m_measurementSTLReader->SetFileName("C:/Joey/ultrasteer/models/4mmBentTip.STL");
  ...
  void TeleoperationVisualizationWidget::onUpdateVisualization(void)
  {
    ...
    if( !Ttrans2robot.isZero() ){
      ...
      case QtEnums::Transducer::LINEAR :
        m_transducerSTLReader->SetFileName("C:/Joey/ultrasteer/models/L14-5GPS.STL");
        break;
      case QtEnums::Transducer::CONVEX :
        m_transducerSTLReader->SetFileName("C:/Joey/ultrasteer/models/C-52GPS.STL");
        break;
      }
