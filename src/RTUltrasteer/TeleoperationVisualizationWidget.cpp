...
namespace Nf
{
  ...
  void TeleoperationVisualizationWidget::initViewport(void)
  {
    if( !m_viewportInit ){ // if not already initialized
      // robot model
      m_robotSTLReader->SetFileName(BASE_PATH_CAT("ultrasteer/models/NeedleSteeringRobot.STL"));
      ...
      // estimate tip model
      m_estimateSTLReader->SetFileName(BASE_PATH_CAT("ultrasteer/models/8mmBentTip.STL"));
      ...
      m_measurementSTLReader->SetFileName(BASE_PATH_CAT("ultrasteer/models/4mmBentTip.STL"));
  ...
  void TeleoperationVisualizationWidget::onUpdateVisualization(void)
  {
    ...
    if( !Ttrans2robot.isZero() ){
      ...
      case QtEnums::Transducer::LINEAR :
        m_transducerSTLReader->SetFileName(BASE_PATH_CAT("ultrasteer/models/L14-5GPS.STL"));
        break;
      case QtEnums::Transducer::CONVEX :
        m_transducerSTLReader->SetFileName(BASE_PATH_CAT("ultrasteer/models/C-52GPS.STL"));
        break;
      }
